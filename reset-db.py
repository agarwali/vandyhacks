...
def add_dummy_users():
  T = model.User
  new_user = model.User(first_name="Aleksandra",address1="101 Chestnut St." city="Berea" state="KY" address2="" last_name="Long",phone="9568565255",time=1476377751.49,token="oasda",email="employer@gmail.com").save()
